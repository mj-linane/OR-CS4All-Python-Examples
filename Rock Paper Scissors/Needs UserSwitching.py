...
def check_winner():
    ...
    if num_players == 1:
        ...
        print("The computer's score is: ", player2_score, '\n')
    else:
        print("\nPlayer 1's score is: ", player1_score)
...
def Main():
    ...
    if player1_roll == "ROCK":
        ...
        if player2_roll == "SCISSORS":
            print("You lose!", player2_roll, "cuts", player1_roll)
            player2_score = player2_score + 1
        else:
            print("You win!", player1_roll, "covers", player2_roll)
            player1_score = player1_score + 1
    elif player1_roll == "SCISSORS":
        if player2_roll == "ROCK":
            print("You lose!", player2_roll, "smashes", player1_roll)
            player2_score = player2_score + 1
        else:
            print("You win!", player1_roll, "cuts", player2_roll)
            player1_score = player1_score + 1
    else:
        print("Tie!")
